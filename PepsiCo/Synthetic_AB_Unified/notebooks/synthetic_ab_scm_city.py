...
# MAGIC %md
# MAGIC # Industrial Synthetic A/B for Samokat City-Week Data
# MAGIC
...
# MAGIC
# MAGIC 1. Distribution-adjusted sales rate as the primary outcome (`units_per_warehouse`).
...
# MAGIC 9. Sensitivity readout across raw/rate transformations and pre-period lengths.
...
# ---- Tables ----
DARKSTORE_SALES_TABLE = "ecom_etl.ds_Samokat_availability_metrics_city"
...
OUTPUT_ROOT = "/mnt/data/synthetic_ab_scm_city"

# ---- City-week sales columns ----
DS_COLS = {
    "barcode":      "gtin",
    "week":         "start_of_week",
    "units":        "sales_quantity",
    "price_promo":  "mode_promo_price",
    "city":         "city_nm",
...
PRIMARY_OUTCOME = "units_per_warehouse"
SECONDARY_OUTCOMES = ["units", "log_units_per_warehouse"]
PRE_WEEKS = 8
...
MISSING_SKU_WEEKS_AS_ZERO = True       # city aggregates can omit zero-sale SKU-weeks
